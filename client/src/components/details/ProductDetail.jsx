    ...
    return(
        ...
        <Typography style={{marginTop: 5, color: '#878787', fontSize: 14}}>
         ...
         <SmallText>
            ...
            <Typography><StyledBadge/>Get extra 13%o off (price inclusive of discount) T&C</Typography>
            <Typography><StyledBadge/>Sign up for Flipkart Pay Later and get Flipkart Gift Card worth ₹100* Know More T&C</Typography>
